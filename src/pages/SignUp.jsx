    ...
    <section>
      ...
      <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
        ...
        <input  className='w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transition ease-in-out mb-6' type='text' id="name" value={name} onChange={onChange} placeholder= 'Full Name'/>
          ...
          <button type='submit' className='w-full bg-blue-600 text-white px-7 py-3 text-sm font-medium uppercase rounded shadow-lg hover:bg-blue-700 transition duration-150 ease-in-out active:bg-blue-800'>Sing Up</button>
