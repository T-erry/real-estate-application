        ...
        <div className="w-full md:w-[50%] mt-6 px-3">
          ...
          ${changeDetail && "bg-red-200  focus:bg-red-200"}`}
            ...
            <input
              ...
              value={email}
              disabled
              className="w-full  px-6  py-2 text-xl text-gray-700 bg-white border border-grey-300 rounded transition ease-in-out"
            />
          ...
          <button
            type="submit"
            className="w-full bg-blue-600 text-white uppercase px-7 py-3 text-sm font-medium rounded shadow-md hover:bg-blue-700 cursor-pointer transition duration-150ms ease-in-out hover:shadow-lg active:bg-blue-800"
          >
            <Link
              to="/create-listing"
